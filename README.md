...
- `BSKY_OAUTH_SCOPE`: override OAuth scope (default: `atproto repo:app.bsky.feed.post?action=create repo:app.bsky.actor.profile?action=create&action=update blob:*/* rpc:app.bsky.actor.getProfile?aud=did:web:api.bsky.app#bsky_appview rpc:app.bsky.feed.searchPosts?aud=did:web:api.bsky.app`)
